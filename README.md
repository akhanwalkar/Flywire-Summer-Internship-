...
Disagreement Rate
\text{disagreement rate} = \frac{\text{# mismatched pairs}}{n^2}
Interpretation:
0.00 → perfect match
0.04 → 96% agreement 
higher → noisier
...
Final Parameters
Pythonmax_total_mismatches = 5max_disagreement_rate = 0.03max_local_add_cost = 1max_frontier_per_graph = 25max_nodes_per_colour = 6Show more lines
